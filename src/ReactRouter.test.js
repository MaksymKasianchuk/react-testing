...
describe("React Router", () => {
  it("should render the home page", () => {
    ...
    expect(screen.container.innerHTML).toMatch("Home page");
  ...
  it("should navigate to the contact page", () => {
    ...
    expect(screen.container.innerHTML).toMatch("John Doe");
  });
  ...
  it("should navigate to error page if route is wrong", () => {
    ...
    //   route: "/wrong-route",
    // });
    expect(screen.container.innerHTML).toMatch("404 Error");
  });
